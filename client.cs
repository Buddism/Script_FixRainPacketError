package Script_FixRainPacketError
{
	function AvatarGui::onWake (%this)
	{
		if ($AvatarHasLoaded || isObject(mDTS))
			return parent::onWake (%this);

		//create mDTS before the AvatarGui so it doesnt create it using a datablock
...
activatePackage(Script_FixRainPacketError);